...
:root {
  ...
  */
  ...
  --dark-filter: brightness(0.91) grayscale(0.15) invert(0.95) sepia(0.65) hue-rotate(180deg);
  --nord-filter: invert(81%) sepia(23%) saturate(459%) hue-rotate(181deg) brightness(90%) contrast(93%);
